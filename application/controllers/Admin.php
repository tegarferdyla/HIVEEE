...
class Admin extends CI_Controller {
	...
	public function cekdetail($id_kandidat){
		$this->load->view('admin/header');
		$this->load->view('admin/sidebar');
		$data['detail_kandidat'] = $this->Datakandidat_model->getwherekandidat($id_kandidat); 
		$this->load->view('admin/cekdetail',$data);
		$this->load->view('admin/footer');
	}
	public function cekdetailperusahaan($id_perusahaan){
		$this->load->view('admin/header');
		$this->load->view('admin/sidebar');
		$data['detail_perusahaan'] = $this->Dataperusahaan_model->getwhereperusahaan($id_perusahaan); 
		$this->load->view('admin/cekdetailperusahaan',$data);
		$this->load->view('admin/footer');
	}
	public function cetakkandidatnonaktive(){
		$data['nonactive'] = $this->Datakandidat_model->kandidatnonaktif();
		$this->load->view('admin/cetaklaporan',$data);
	}
	public function cetakkandidataktive(){
		$data['active'] = $this->Datakandidat_model->kandidataktif();
		$this->load->view('admin/cetaklaporanaktiv',$data);
	}
	public function cetakperusahaanaktive(){
		$data['active'] = $this->Dataperusahaan_model->perusahaanaktif();
		$this->load->view('admin/cetakperusahaanaktiv',$data);
	}
	public function cetakperusahaannonaktive(){
