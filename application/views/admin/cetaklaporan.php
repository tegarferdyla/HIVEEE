                        ...
                        <tbody>
                            <tr class="col-header nama-mitra">
                                ...
                                <td style="padding: 20px;" colspan="3">
                                    <h2 class="col-white">Laporan Kandidat Non Aktive</h2>
                                    <small class="col-white"><i>Berikut adalah laporan dari daftar kandidat yang non active</i></small>
                                </td>
                            </tr>
                    ...
                    <table width="100% isi-laporan">
                        ...
                        <?php foreach ($nonactive as $a) { ?>
                                <tr style="font-size: 13px;" class="bg-grey">
                                    ...
                                    <td class="p-10 center">NON - ACTIVE</td>
                                </tr>
                           <?php } ?>     
                        </tbody>
                    </table>
