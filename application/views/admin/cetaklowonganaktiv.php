                        ...
                        <tbody>
                            <tr class="col-header nama-mitra">
                                ...
                                <td style="padding: 20px;" colspan="3">
                                    <h2 class="col-white">Laporan Lowongan Aktive</h2>
                                    <small class="col-white"><i>Berikut adalah laporan dari daftar lowongan ydang dibuat oleh perusahaan yang berstatus aktif</i></small>
                                </td>
                            </tr>
                    ...
                    <table width="100% isi-laporan">
                        <tbody>
                            <tr>
                                ...
                                <td class="p-10 col-white bg-tosca">NAMA LOWONGAN</td>
                                <td class="p-10 col-white bg-tosca">KATEGORI</td>
                                <td class="p-10 col-white bg-tosca">AGENCY / PERUSAHAAN</td>
                                <td class="p-10 col-white bg-tosca">BATAS PENDAFTARAN</td>
                        ...
                        <?php foreach ($active as $a) { ?>
                                <tr style="font-size: 13px;" class="bg-grey">
                                    ...
                                    <td class="p-10 center"><?php echo ucwords($a->nama_lowongan); ?> </td>
                                    <td class="p-10 center"><?php echo ucwords($a->kategori); ?> </td>
                                    <td class="p-10 center"><?php echo ucwords($a->nm_perusahaan); ?> </td>
                                    <td class="p-10 center"><?php echo ucwords($a->bataspendaftaran); ?> </td>
