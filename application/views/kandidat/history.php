...
<section>
	<div class="container">
		...
		<div class="col-md-3 col-sm-3">
			<div class="emp-pic">
				<img src="<?php echo base_url('assets/img/'.$k->foto) ?>" class= "img-responsive img-circle width-220" alt="">
			</div>
		</div>	
		<div class="col-md-4 col-sm-4">
			<div class="emp-des">
				<h3><?php echo $k->nama ?></h3>
				<p><i class="ti-location-pin padd-r-5"></i><?php echo $k->alamat; ?></p> 
				<p><i class="ti-email padd-r-5"></i> <?php echo $k->email; ?></p>
			</div>
			<div class="emp-bt">
