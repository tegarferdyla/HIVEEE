	...
	<!-- Side Bar -->
        ...
        ?>
							...
							<label for="">Tanggal Lahir</label>
							 <input type="text" name="tgl_lahir" id="dob2" data-lang="en" data-large-mode="true" data-min-year="1940" data-max-year="2020" data-disabled-days="08/17/2017,08/18/2017" data-id="datedropper-0" data-theme="my-style" class="form-control " readonly="">
						</div>
