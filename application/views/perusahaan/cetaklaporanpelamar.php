                        ...
                        <tbody>
                            <tr class="col-header nama-mitra">
                                ...
                                <td style="padding: 20px;" colspan="3">
                                    <h2 class="col-white">Laporan Pelamar </h2>
                                    <small class="col-white"><i>Berikut adalah laporan dari pelamar yang telah mendaftar pada lowongan ini</i></small>
                                </td>
                            </tr>
                            ...
                            <tr style="font-size: 13px;">
                                <td style="font-weight: 600;" colspan="3" class="col-tosca">
                                   ...
                                   <p>Nama Perusahaan : <?php echo $k->nm_perusahaan; ?></p>
                                </td>
                                <td style="font-weight: 600;" class="col-tosca" style="padding: 20px;" colspan="1">
                                   <p style="float: right;"> 
                                    Nama Lowongan : <?php echo $k->nama_lowongan; ?>
                                    <?php } ?>
                                   </p>
                                </td>
                            </tr>
                    ...
                    <table width="100% isi-laporan">
                        <tbody>
                            <tr>
                                ...
                                <td class="p-10 col-white bg-tosca">ID KANDIDAT</td>
                                <td class="p-10 col-white bg-tosca">NAMA</td>
                            ...
                            <?php $no=1; ?>
                        <?php foreach ($lowonganlamar as $a) { ?>
                                <tr style="font-size: 13px;" class="bg-grey">
                                    <td class="p-10 center"><?php echo $no++; ?></td>
                                    <td class="p-10 center"><?php echo ucwords($a->id_kandidat); ?> </td>
                                    <td class="p-10 center"><?php echo ucwords($a->nama); ?> </td>
                                    <td class="p-10 center"><?php echo ucwords($a->email); ?> </td>
                                    <td class="p-10 center"><?php echo ucwords($a->telp); ?> </td>
                                    <td class="p-10 center"><?php echo ucwords($a->status); ?></td>
                                </tr>
                           <?php } ?>     
                        </tbody>
                    </table>
